    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-bg p-6">
            <div className="w-full max-w-3xl bg-sandstone rounded-xl shadow-md p-6 md:p-8">
                ...
                <div className="mt-8 bg-viridiam rounded-2xl shadow-lg p-6 md:p-8 mx-auto">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-link text-white py-3 rounded-lg font-semibold hover:bg-link-hover transition"
                        >
